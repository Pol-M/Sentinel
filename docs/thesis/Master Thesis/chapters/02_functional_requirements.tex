...
\begin{itemize}
    \item \textbf{Normal ascent / rope pull-in}, where the climber is
        ...
        comparatively gradual rate.
    \item \textbf{A fall event}, characterised by a sudden increase in
        rope acceleration and/or a rapid increase in measured rope
...
manual reset is explicitly designed as a deliberate safety fallback.
...
\begin{itemize}
    ...
    \item \textbf{Rappel / Abseil Mode}: a mode that allows a controlled,
...
\begin{itemize}
    ...
    \item If the battery level drops to a low or critical level
        ...
        rather than left in an unsupported state.
\end{itemize}
